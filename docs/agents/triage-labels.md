...
Because this repo tracks issues as local markdown (see `issue-tracker.md`), there are no tracker labels — the role is written as the value of the `Status:` line near the top of each issue file, e.g. `Status: ready-for-agent`.
